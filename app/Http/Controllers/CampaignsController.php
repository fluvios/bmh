...
class CampaignsController extends Controller
{
  ...
  public function getDeadline($deadline)
  {
    ...
    switch ($deadline) {
      case 7:
      $query = DB::raw('NOW() + INTERVAL 1 DAY');
      break;
      case 30:
      $query = DB::raw('NOW() + INTERVAL 30 DAY');
      break;
      case 90:
      $query = DB::raw('NOW() + INTERVAL 90 DAY');
      break;
      case 180:
      $query = DB::raw('NOW() + INTERVAL 3 MONTH');
      break;
      case 365:
      $query = DB::raw('NOW() + INTERVAL 1 YEAR');
      break;
      default:
      # code...
      break;
