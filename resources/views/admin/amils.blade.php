...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h4>
      ...
      <a href="{{{ url('panel/admin/amils/add') }}}" class="btn btn-sm btn-success no-shadow pull-right">
        <i class="glyphicon glyphicon-plus myicon-right"></i> Add Amil
      </a>
    </h4>
  </section>
          ...
          <div class="box-header">
            <h3 class="box-title">
              @if( $data->count() != 0 && $data->currentPage() != 1 )
                <a href="{{url('panel/admin/amils')}}">{{ trans('admin.view_all_members') }}</a>
              @else
                {{ trans('admin.members') }}
              @endif
            </h3>
            ...
            <table class="table table-hover">
              <tbody>
                ...
                <tr>
                  ...
                  <th class="active">{{ trans('admin.birthdate') }}</th>
