                  ...
                  @foreach($data as $donation)
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="{{ url('panel/admin/donations/status/reject').'/'.$donation->id }}" class="btn btn-danger btn-xs padding-btn">Tolak</a>
                        <a href="{{ url('panel/admin/donations/status/accept').'/'.$donation->id }}" class="btn btn-success btn-xs padding-btn">Terima</a>
                    </td>
                    </tr><!-- /.TR -->
                  @php
                    $i++;
