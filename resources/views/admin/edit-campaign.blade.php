                ...
                <form class="form-horizontal" method="POST" action="{{ url('panel/admin/campaigns/edit/'.$data->id) }}" enctype="multipart/form-data">
                 ...
                 <!-- Start Box Body -->
                  ...
                  <div class="box-body">
                      ...
                      <label class="col-sm-2 control-label"s>{{ trans('misc.choose_a_category') }}</label>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Kategori Campaign</label>
                      <div class="col-sm-10">
                 ...
                 <!-- Start Box Body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Akun Transaksi</label>
                      <div class="col-sm-10">
                        <select class="form-control select2" id="akun-transaksi-id" name="akun_transaksi_id">
                          @if($akunTransaksi = $data->getAkunTransaksi())
                            <option value="{{ $data->akun_transaksi_id }}" selected>{{ $akunTransaksi->nomor. ' - '.$akunTransaksi->nama }}</option>
                          @endif
                        </select>
                      </div>
                    </div>
...
initTinymce();	
  ...
  $('#akun-transaksi-id').select2({
    ajax: {
      url: '{{ url('api/akun-transaksi') }}',
      dataType : 'json',
      delay : 220,
      data : function(params){
          return {
