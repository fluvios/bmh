                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <input type="number" min="0" autocomplete="off" value="{{ $settings->min_campaign_amount }}" name="min_campaign_amount" class="form-control onlyNumber" placeholder="{{ trans('admin.min_campaign_amount') }}">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <input type="number" min="0" autocomplete="off" value="{{ $settings->max_campaign_amount }}" name="max_campaign_amount" class="form-control onlyNumber" placeholder="{{ trans('admin.max_campaign_amount') }}">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <input type="number" min="0" autocomplete="off" value="{{ $settings->min_donation_amount }}" name="min_donation_amount" class="form-control onlyNumber" placeholder="{{ trans('admin.min_donation_amount') }}">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <input type="number" min="0" autocomplete="off" value="{{ $settings->max_donation_amount }}" name="max_donation_amount" class="form-control onlyNumber" placeholder="{{ trans('misc.max_donation_amount') }}">
