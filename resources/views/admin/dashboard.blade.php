<?php 
	...
	$total_donations = App\Models\Donations::where('payment_status', '=', 'paid')->count();
...
new Morris.Area({ 
  ...
  data: [
    ...
    for ( $i=0; $i < 30; ++$i) { 
		...
		$_donations = App\Models\Donations::whereRaw("DATE(payment_date) = '".$date."'")->where('payment_status', '=', 'paid')->count();
