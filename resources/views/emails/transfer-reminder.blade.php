                                    ...
                                    <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                        ...
                                        <!-- Intro -->
                                            ...
                                            <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                               ...
                                               {{ env('APP_URL') }} Segera transfer TEPAT {{ $amount }} ke rek {{ $bank->name }} {{ $bank->account_number }} an.  {{ $bank->account_name }} untuk donasi <a href="{{ route('campaign-detail-page', [$campaign->id, str_slug($campaign->title)]) }}">#{{ $campaign->id }}</a>  sebelum {{ $expiry }} WIB
