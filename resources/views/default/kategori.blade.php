...
@section('title'){{ $category->nama.' - ' }}@endsection
...
<div class="col-md-12 margin-top-20 margin-bottom-20">	
	...
	<h2 class="subtitle-color-7 margin-bottom-20 text-center text-uppercase">Kategori <a>{{ $category->nama }}
       </a> </h2>
	...
	@if( $data->total() != 0 )	
	     ...
	     @include('includes.kategori-campaigns')
